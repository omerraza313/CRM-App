                          ...
                          <div class="card-body">
                            <p>Do You Want to Delete <strong>{{$list->name}}</strong> Material</p>
                              <div class="modal-footer justify-content-between">
                                ...
                                <a href="{{url('material/delete-material/')}}/{{$list->id}}" class="btn btn-danger">Delete</a>
                              </div>
                  ...
                  <div class="card-body">
                    <form method="POST" action="{{route('edit.material')}}">
                      ...
                      <div class="form-group">
                        <label for="category-name">Material Name</label>
            ...
            <div class="modal fade" id="modal-add">
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="card-body">
                    <form method="POST" action="{{route('create.material')}}">
                      @csrf
                      <div class="form-group">
                        <label for="material-name">Material Name</label>
                        <input type="text" class="form-control" name="name" id="material-name" placeholder="Material Name" required="">
                      </div>
