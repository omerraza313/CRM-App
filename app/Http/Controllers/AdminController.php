...
/****SUB MATERIAL*****/
     ...
     public function add_sub_material(Request $request){
        ...
        $model->save();
        return redirect('/sub_material')->with('msg', 'Sub Material Inserted');
     ...
     public function delete_sub_material($id)
    {
        ...
        return redirect('/sub_material')->with('msg', 'Sub Material Deleted');
    }
    ...
    /****VENDOR*****/
     ...
     public function vendor(){
        ...
        $material = Material::all();
        $vendor = Vendor::all();
        return view('Admin.vendor.vendor', compact('material','vendor'));
    ...
    public function edit_vendor(Request $request){
        ...
        if ($edit_vendor->username == $request->username) {
            ...
            $edit_vendor->material_id = $request->material_id;
